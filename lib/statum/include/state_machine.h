...
/*  ************************************************************
    ...
    I don't know or understand. In addition, I need to be clear on 
    a Pure C source.

    In addition, I want to make the following into a shared lib:
        -   fb_allocator
        -   x_allocator
        -   sm_allocator

    ... until then, the standard malloc & free will suffice...
    ************************************************************
